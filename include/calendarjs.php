...
require_once XOOPS_ROOT_PATH . '/modules/xasset/language/' . $GLOBALS['xoopsConfig']['language'] . '/calendar.php';

?>
<link rel="stylesheet" type="text/css" media="all"
      href="<?php echo XOOPS_URL; ?>/modules/xasset/include/calendar-blue.css">
<script type="text/javascript" src="<?php echo XOOPS_URL . '/modules/xasset/include/calendar.js'; ?>"></script>
