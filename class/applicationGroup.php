...
class XassetApplicationGroup extends XassetBaseObject
{
    ...
    {
        $app = xoops_getModuleHandler('application', 'xasset');
...
/**
 * Class xassetApplicationGroupHandler
 */
class XassetApplicationGroupHandler extends XassetBaseObjectHandler
{
    //vars
    public $_db;
    public $classname = 'xassetapplicationgroup';
     ...
     * @param $db
     *
     * @return xassetApplicationGroupHandler
     */
