...
/**
 * Class xassetApplicationProductMemb
 */
...
/**
 * Class xassetApplicationProductMembHandler
 */
class XassetApplicationProductMembHandler extends XassetBaseObjectHandler
{
    //vars
    public $_db;
    public $classname = 'xassetapplicationproductmemb';
     ...
     * @param $db
     *
     * @return xassetApplicationProductMembHandler
     */
