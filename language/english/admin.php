...
define('_AM_XASSET_UPGRADEFAILED0', "Update failed - couldn't rename field '%s'");
define('_AM_XASSET_UPGRADEFAILED1', "Update failed - couldn't add new fields");
define('_AM_XASSET_UPGRADEFAILED2', "Update failed - couldn't rename table '%s'");
define('_AM_XASSET_ERROR_COLUMN', 'Could not create column in database : %s');
