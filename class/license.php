...
/**
 * Class xassetLicenseHandler
 */
class XassetLicenseHandler extends XassetBaseObjectHandler
{
    //vars
    public $_db;
    public $classname = 'xassetlicense';
    public $_dbtable  = 'xasset_license';
     ...
     * @return array
     */
    public function getLicensesArray($criteria)
    {
        global $imagearray;
        //
        ...
        //
        foreach ($objs as $obj) {
            $actions = '<a href="main.php?op=viewLicense&id='
                       . $obj->getVar('id')
                       . '">'
                       . $imagearray['viewlic']
                       . '</a>'
                       . '<a href="main.php?op=editLicense&id='
                       . $obj->getVar('id')
                       . '">'
                       . $imagearray['editimg']
                       . '</a>'
                       . '<a href="main.php?op=deleteLicense&id='
                       . $obj->getVar('id')
                       . '">'
     ...
     * @return array
     */
    public function getAppLicenses($appid)
    {
        global $imagearray;
        //
     ...
     * @return array
     */
    public function getUserApplicationArray($uid, $crit = null)
    {
     ...
     * @return array
     */
    public function getLicenseArray($crit)
    {
        global $imagearray;
        //
        $appTable  = $this->_db->prefix('xasset_application');
        ...
        if ($res = $this->_db->query($sql)) {
            while ($row = $this->_db->fetcharray($res)) {
                ...
                $actions = '<a href="main.php?op=viewClientLicenses&id='
                           ...
                           . $imagearray['viewlic']
                           . '</a>'
                           . '<a href="main.php?op=editClientLicenses&id='
                           . $row['uid']
                           . '">'
                           . $imagearray['editimg']
                           . '</a>'
                           . '<a href="main.php?op=deleteClientLicense&id='
                           . $row['uid']
                           . '">'
                           . $imagearray['deleteimg']
                           . '</a>';
                //
                $ar[] = [
                    'uid'      => '<a href="index.php?op=viewClientLicenses&id=' . $row['uid'] . '&appid=' . $appid . '">' . $row['uid'] . '</a>',
                    'uname'    => $row['uname'],
                    'licenses' => $row['licenses'],
                    'actions'  => $actions
                ];
     ...
     * @return array
     */
    public function getClientLicenses($appid, $clientid)
    {
        global $imagearray;
        //
     ...
     * @return int
     */
    public function getAllLicensesCount()
    {
